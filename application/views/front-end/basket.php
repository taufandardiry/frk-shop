    ...
    <div id="content">
      <div class="container">
        ...
        <div class="col-md-9" id="basket">
          <div class="box">
            <form method="post" action="<?php echo base_url()."index.php/MyController/checkout1page" ?>">
              <h1>Shopping cart</h1>
              ...
              <div class="box-footer">
                <div class="pull-left">
                  <a href="<?php echo base_url()."index.php/MyController/categorypage" ?>" class="btn btn-default"><i class="fa fa-chevron-left"></i> Continue shopping</a>
                </div>
