    ...
    <div id="content">
      <div class="container">
        ...
        <div class="col-md-9" id="checkout">
          <div class="box">
            <form method="post" action="<?php echo base_url()."index.php/MyController/checkout4page" ?>">
                  ...
                  <div class="col-sm-6">
                    <div class="box payment-method">
                      ...
                      <div class="box-footer text-center">
                        <input type="radio" name="payment" value="payment2"> </div>
                    </div>
                  </div>
                  <div class="col-sm-6">
                    <div class="box payment-method">
              ...
              <div class="box-footer">
                <div class="pull-left">
                  <a href="<?php echo base_url()."index.php/MyController/checkout2page" ?>" class="btn btn-default"><i class="fa fa-chevron-left"></i>Back to Shipping method</a>
                </div>
