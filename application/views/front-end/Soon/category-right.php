            ...
            <div class="panel-body">
              <ul class="nav nav-pills nav-stacked category-menu">
                <li class="active">
                  ...
                  <ul>
                    <li>
                      <a href="category.html">Jilbab</a>
                    </li>
                    <li>
                      <a href="category.html">Ciput</a>
                    </li>
                    <li>
                      <a href="category.html">Kaos Kaki</a>
                    </li>
                    <li>
              ...
              <form>
                <div class="form-group">
                  <div class="checkbox"> <label>
                                            <input type="checkbox" value="on">Jilbab (20)
                                        </label> </div>
                  <div class="checkbox"> <label>
                                            <input type="checkbox" value="on">Ciput (5)
                                        </label> </div>
                  <div class="checkbox"> <label>
                                            <input type="checkbox" value="on">Kaos Kaki (5)
                                        </label> </div>
                  <div class="checkbox"> <label>
                                            <input type="checkbox" value="on">Handmade Accessories (10)
                                        </label> </div>
                </div>
          ...
          <div class="panel panel-default sidebar-menu">
            ...
            <div class="panel-body">
              <form>
                <div class="form-group">
                  <div class="checkbox"> <label>
                                            <input type="checkbox" value="on"> <span class="colour white"></span> White (10)
                                        </label> </div>
                  <div class="checkbox"> <label>
                                            <input type="checkbox" value="on"> <span class="colour blue"></span> Blue (10)
                                        </label> </div>
                  <div class="checkbox"> <label>
                                            <input type="checkbox" value="on"> <span class="colour green"></span> Green (10)
                                        </label> </div>
                  <div class="checkbox"> <label>
                                            <input type="checkbox" value="on"> <span class="colour yellow"></span> Yellow (10)
                                        </label> </div>
                  <div class="checkbox"> <label>
                                            <input type="checkbox" value="on"> <span class="colour red"></span> Red (10)
                                        </label> </div>
                </div>
                <button class="btn btn-default btn-sm btn-primary"><i class="fa fa-pencil"></i> Apply</button>
              </form>
