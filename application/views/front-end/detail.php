      ...
      <div class="container">
        <div class="col-md-12">
          <ul class="breadcrumb">
            ...
            <li>
              <a href="<?php echo base_url()."index.php/MyController/categorypage" ?>">Product</a>
            </li>
          ...
          <div class="panel panel-default sidebar-menu">
            ...
            <div class="panel-body">
              <ul class="nav nav-pills nav-stacked category-menu">
                <li class="active">
                  <a href="<?php echo base_url()."index.php/MyController/categorypage" ?>">Ladies <!-- <span class="badge pull-right">40</span> --></a>
                  <ul>
                    <li>
                      <a href="<?php echo base_url()."index.php/MyController/categorypage" ?>">Jilbab</a>
                    </li>
