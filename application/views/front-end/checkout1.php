    ...
    <div id="content">
      <div class="container">
        ...
        <div class="col-md-9" id="checkout">
          <div class="box">
            <form method="post" action="<?php echo base_url()."index.php/MyController/checkout2page" ?>">
              <h1>Checkout</h1>
              ...
              <div class="box-footer">
                <div class="pull-left">
                  <a href="<?php echo base_url()."index.php/MyController/basketpage" ?>" class="btn btn-default"><i class="fa fa-chevron-left"></i>Back to basket</a>
                </div>
