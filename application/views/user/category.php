          ...
          <div class="panel panel-default sidebar-menu">
            ...
            <div class="panel-body">
              <ul class="nav nav-pills nav-stacked category-menu">
                <li class="active">
                  <a href="<?php echo base_url()."index.php/MyControllerUser/categorypage" ?>">Ladies <!-- <span class="badge pull-right">30</span> --></a>
                  <ul>
                    <li>
                      <a href="<?php echo base_url()."index.php/MyControllerUser/categorypage" ?>">Jilbab</a>
                    </li>
            ...
            <div class="col-md-4 col-sm-6">
              <div class="product">
                <div class="flip-container">
                  <div class="flipper">
                    <div class="front">
                      <a href="<?php echo base_url()."index.php/MyControllerUser/detailpage" ?>">
                ...
                <a href="<?php echo base_url()."index.php/MyControllerUser/detailpage" ?>" class="invisible">
                  <img src="<?php echo base_url().'/upload/'.$x['image']; ?>" alt="" class="img-responsive"> </a>
                <div class="text">
                  <h3>
                    <a href="<?php echo base_url()."index.php/MyControllerUser/detailpage" ?>"><?= $x['nama_barang'] ?></a>
                  </h3>
                  <p class="price">RP <?= $x['harga'] ?></p>
                  <p class="buttons">
                    <a href="<?php echo base_url()."index.php/MyControllerUser/detailpage" ?>" class="btn btn-default">View detail</a>
                    <?=anchor('MyControllerUser/add_to_cart/' . $x['kode_barang'], 'Add to cart' , ['class' => 'btn btn-primary','role'  => 'button'])?>
                  </p>
                </div>  
                <!-- /.text -->
              </div>
