        ...
        <div class="col-md-9">
          <div class="box" id="text-page">
            ...
            <p class="lead">Ini merupakan website official dari
              <a href="<?php echo base_url()."index.php/MyControllerUser/index" ?>" class="external">FRK Olshop</a>.</p>
            ...
            <blockquote>
              ...
              <a href="<?php echo base_url()."index.php/MyControllerUser/index" ?>" class="external">disini</a>.</p>
            </blockquote>
