    ...
    <div id="content">
      <div class="container">
        ...
        <div class="col-md-9" id="checkout">
          <div class="box">
            <form method="post" action="<?php echo base_url()."index.php/MyControllerUser/checkout3page" ?>">
                ...
                <div class="row">
                  <div class="col-sm-6">
                    <div class="box shipping-method">
                      <h4>JNE YES</h4>
                      <p>Pengiriman dengan lama 1 hari sampai.</p>
                      <div class="box-footer text-center">
                        <input type="radio" name="delivery" value="delivery1" checked> </div>
                    </div>
                  </div>
                  <div class="col-sm-6">
                    <div class="box shipping-method">
                      <h4>JNE REG</h4>
                      <p>Pengiriman dengan lama 2-3 hari.</p>
                      <div class="box-footer text-center">
                        <input type="radio" name="delivery" value="delivery2"> </div>
                    </div>
                  </div>
                  <div class="col-sm-6">
                    <div class="box shipping-method">
                      <h4>JNE OKE</h4>
                      <p>Pengiriman dengan lama 5-7 hari.</p>
                      <div class="box-footer text-center">
                        <input type="radio" name="delivery" value="delivery3"> </div>
                    </div>
                  </div>
                </div>
                <!-- /.row -->
              ...
              <div class="box-footer">
                <div class="pull-left">
                  <a href="<?php echo base_url()."index.php/MyControllerUser/basketpage" ?>" class="btn btn-default"><i class="fa fa-chevron-left"></i>Back to Cart</a>
                </div>
                <div class="pull-right">
                  <a class="btn btn-primary" href="<?php echo base_url()."index.php/MyControllerUser/checkout3page" ?>" class="btn btn-default">Continue to Payment Method<i class="fa fa-chevron-right"></i> </a>
                </div>
              </div>
            </form>
          </div>
