    ...
    <div class="container">
      <div class="navbar-header">
        ...
        <div class="navbar-buttons">
          ...
          <a class="btn btn-default navbar-toggle" href="<?php echo base_url()."index.php/MyController/basketpage" ?>"> <i class="fa fa-shopping-cart"></i> <span class="hidden-xs">View items in cart</span> </a>
        </div>
      </div>
      <!--/.navbar-header -->
        ...
        <div class="container">
          <div class="col-md-12">
            ...
            <p class="lead">Bagaimana perkembangan fashion masa kini?
              <a href="<?php echo base_url()."index.php/MyControllerUser/textpage" ?>">Ini tentang frk oshop!</a>
            </p>
          </div>
        </div>
      </div>
