    ...
    <div id="content">
      <div class="container">
        ...
        <div class="col-md-9" id="checkout">
          <div class="box">
            <form method="post" action="<?php echo base_url()."index.php/MyControllerUser/inputOrder" ?>">
              <h1>Checkout</h1>
              <ul class="nav nav-pills nav-justified">
                <li>
                  <a href="<?php echo base_url()."index.php/MyControllerUser/checkout2page" ?>"><i class="fa fa-truck"></i>
                    <br>Delivery Method</a>
                </li>
                <li>
                  <a href="<?php echo base_url()."index.php/MyControllerUser/checkout3page" ?>"><i class="fa fa-money"></i>
                    <br>Payment Method</a>
                </li>
                <li class="active">
              ...
              <!-- <form method="post" action="<?php echo base_url("MyControllerUser/inputOrder"); ?>"> -->
                <div class="content">
                <div class="row">
                  <div class="col-sm-6">
                    <div class="form-group"> <label for="firstname">Firstname</label>
                      <input type="text" class="form-control" id="firstname" value="<?php echo $this->session->userdata('nama_depan') ?>" disabled=""> </div>
                  </div>
                  <div class="col-sm-6">
                    <div class="form-group"> <label for="lastname">Lastname</label>
                      <input type="text" class="form-control" id="lastname" value="<?php echo $this->session->userdata('nama_belakang') ?>" disabled=""> </div>
                  </div>
                </div>
                <!-- /.row -->
                <div class="row">
                  <div class="col-sm-12">
                    <div class="form-group"> <label for="street">Alamat</label>
                ...
                <div class="row">
                  <div class="col-sm-6">
                    <div class="form-group"> <label for="city">Kota</label>
                      <input type="text" class="form-control" name="kota"> </div>
                  </div>
                  <div class="col-sm-6">
                    <div class="form-group"> <label for="zip">Kode Pos</label>
                      <input type="text" class="form-control" name="kode_pos"> </div>
                  </div>
                  <div class="col-sm-12">
              ...
              <div class="box-footer">
                <div class="pull-left">
                  <a href="<?php echo base_url()."index.php/MyControllerUser/checkout3page" ?>" class="btn btn-default"><i class="fa fa-chevron-left"></i>Back to Payment Method</a>
                </div>
            ...
            <div class="table-responsive">
              <table class="table">
                <tbody>
                  ...
                  <tr class="total">
                    <td>Total</td>
                    <th>RP <?= number_format(25000+$this->cart->total(),0,',','.'); ?></th>
                  </tr>
                </tbody>
              </table>
            </div>
