    ...
    <div id="content">
      <div class="container">
        ...
        <div class="col-md-9" id="checkout">
          <div class="box">
            <form method="post" action="<?php echo base_url()."index.php/MyControllerUser/checkout4page" ?>">
              ...
              <ul class="nav nav-pills nav-justified">
                ...
                <li class="disabled">
                  <a href="<?php echo base_url()."index.php/MyControllerUser/checkout1page" ?>"><i class="fa fa-map-marker"></i>
                    <br>Address &amp; Review</a>
                </li>
                <li class="disabled">
                  ...
                  <div class="col-sm-6">
                    <div class="box payment-method">
                      ...
                      <div class="box-footer text-center">
                        <input type="radio" name="payment" value="payment2" checked> </div>
                    </div>
                  </div>
                  <div class="col-sm-6">
                    <div class="box payment-method">
                      <h4>Cash on delivery</h4>
                      <p>Melakukan pembayaran pada kurir pengantar.</p>
                      <div class="box-footer text-center">
                        <input type="radio" name="payment" value="payment3"> </div>
                    </div>
                  </div>
                </div>
                <!-- /.row -->
              ...
              <div class="box-footer">
                <div class="pull-left">
                  <a href="<?php echo base_url()."index.php/MyControllerUser/checkout2page" ?>" class="btn btn-default"><i class="fa fa-chevron-left"></i>Back to Delivery Method</a>
                </div>
                <div class="pull-right">
                  <a class="btn btn-primary" href="<?php echo base_url()."index.php/MyControllerUser/checkout1page" ?>" class="btn btn-default">Continue to Address &amp; Review<i class="fa fa-chevron-right"></i> </a>
                </div>
              </div>
            </form>
          </div>
